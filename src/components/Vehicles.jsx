...
export const Vehicle = ({ item, esFavorito, handleFavorito }) => {

    return (
        <div className="col-12 col-sm-6 col-md-4 col-lg-2">
            <div className="card h-100 bg-secondary text-white mb-3">
                <img alt={item.name} src={`https://raw.githubusercontent.com/dsmora/star-wars-guide/refs/heads/master/build/assets/img/vehicles/${item.uid}.jpg`} />
                <div className="card-body d-flex flex-column text-center align-items-center">
                    ...
                    <Link to={`/vehicle/${item.uid}`} className="btn btn-sm w-75 mt-auto btn-info">Details</Link>
                </div>
            </div>
        </div>
    );
